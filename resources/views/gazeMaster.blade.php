...
@include('layouts.navbars.navs.gazeNav')

  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" id="yield-bg" style=" background-size: cover; background-position: top center;">
